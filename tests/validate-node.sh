...
echo ""
echo "MinIO Console:"
echo "  Note: Console is currently DISABLED in deployment for security"
echo "  To enable: edit deploy-node.sh line 202, set .console.enabled = true"
echo "  Alternative: Use MinIO Client (mc) to create buckets:"
